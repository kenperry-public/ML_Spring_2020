...
class SVM_Helper():
    ...
    def plot_kernel_vs_transform(self, show_margins=True):
        ...
        fig, axs = plt.subplots( math.ceil(len(classifiers)/2.0), 2, figsize=(12, 4 * math.ceil(len(classifiers)/2.0)) )
        axs = np.ravel(axs)
